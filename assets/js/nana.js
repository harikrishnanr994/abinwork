/*!
 * Nana
 * Project Website: http://nana.pimmey.com
 * @version 1.0
...
(function () {
    ...
    App = {
        ...
        initShowMoreCases: function initShowMoreCases () {
            var $showAllCasesBtn = $('#show-all-cases');
            $showAllCasesBtn.on('click', function (e) {
                e.preventDefault();
                $('#hidden-row').removeClass('hide');
                $showAllCasesBtn.hide();
                $('#show-all-cases-container').hide();
            });
        },
